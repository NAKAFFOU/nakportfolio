        ...
        <div class="py-3 px-md-5 container-fluid">
            <div class="row">
                <div class="col-auto col-md-5 align-middle">
                    <p class="mb-0" style="color: var(--light-gray);">© 2024 Nelson AKAFFOU</p>
                    <p class="my-0 pt-0"><a class="" href="mailto:nelsonakaffou@yahoo.fr">nelsonakaffou@yahoo.fr</a></p>
                ...
                <div class="col col-md-7 text-right">
                    ...
                    <p class="my-0 pt-0">
                        ...
                        <a href="www.linkedin.com/in/nelson-akaffou-96a10b12a" target="_blank"><i class="mr-3 fab footer-icons fa-linkedin" aria-hidden="true"></i></a>
